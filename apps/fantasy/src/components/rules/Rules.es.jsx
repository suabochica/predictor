...
export default function RulesEs({
  competitionName,
  maxParticipants,
  squadSize,
  budget,
    ...
    <div className="space-y-8 max-w-3xl pb-8">
      <div>
        ...
        <p className="text-secondary mt-1">
          Guía completa de la Fantasy League{competitionName ? ` — ${competitionName}` : ''}
        </p>
      </div>
      ...
      <Section title="Descripción general">
        <p className="text-secondary">
          Liga privada de fantasy football para {competitionName ?? 'la competición'}. Hasta{' '}
      ...
      <Section title="Ventanas de transferencias">
        ...
        <table className="w-full text-sm border-collapse mb-3">
          ...
          <tbody className="divide-y divide-border text-secondary">
            ...
            <tr><td className="py-2 pr-4">Entre jornadas de liga (fase de grupos)</td><td>{leagueCap} por ventana</td></tr>
            <tr><td className="py-2 pr-4">Entre rondas eliminatorias</td><td>{knockoutCap} por ventana</td></tr>
          </tbody>
        </table>
        <ul className="space-y-2 text-secondary text-sm">
          ...
          <li><Bullet />El presupuesto total ({budget} M) debe respetarse después de cada transferencia.</li>
      ...
      <Section title="Fase de liga">
        {isH2H ? (
          ...
          <ul className="space-y-2 text-secondary">
            <li><Bullet />Los {maxParticipants} participantes acumulan puntos durante <strong className="text-primary">{leagueMatchdayCount} jornadas</strong> (JJ1-JJ{leagueMatchdayCount}, fase de grupos).</li>
