-- 045_save_lineup_captain_lock.sql
-- RPC save_lineup: atomic delete+insert with server-side captain-lock guard.
-- Mirrors the lock pattern in 040_execute_transfer.sql.
-- Replaces the client's direct lineups write in MyTeam.jsx.
